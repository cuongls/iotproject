...
(function () {
    angular.module('app').controller('app.views.DM_SENSOR.createOrEditModal', [
        '$scope', '$uibModalInstance', 'abp.services.app.dM_SENSOR', 'id',
        function ($scope, $uibModalInstance, localService, id) {
            ...
            vm.save = function () {    
                if (id == 0) {
                    localService.createDM_SENSOR(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
                } else {
                    localService.updateDM_SENSOR(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
