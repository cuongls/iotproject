...
(function () {
    angular.module('app').controller('app.views.DM_SENSOR.index', [
        '$scope', '$timeout', '$uibModal', 'abp.services.app.dM_SENSOR',
        function ($scope, $timeout, $uibModal, localService) {
            var vm = this;
            //Định nghĩa các biến 
            //@TODO: Đổi tên địa chỉ dẫn tới file view
            var createOrEditTemplate = '/App/Main/views/DanhMuc/dm_sensor/createOrEditModal.cshtml';            
            //Cấu hình phân trang
            $scope.totalItems = 0;
            $scope.currentPage = 1;
            $scope.maxSize = 5;
            ...
            vm.openCreationModal = function () {
                var modalInstance = $uibModal.open({
                    ...
                    controller: 'app.views.DM_SENSOR.createOrEditModal as vm',
                    backdrop: 'static',
                    resolve: {
                        id: function () {
                            return 0;
