...
(function () {
    angular.module('app').controller('app.views.ThongTin_ThietBi.index', [
        '$scope', '$timeout', '$uibModal', 'abp.services.app.thongTin_ThietBi',
        function ($scope, $timeout, $uibModal, localService) {
            var vm = this;
            //Định nghĩa các biến 
            //@TODO: Đổi tên địa chỉ dẫn tới file view
            var createOrEditTemplate = '/App/Main/views/DanhMuc/thongtin_thietbi/createOrEditModal.cshtml';            
            //Cấu hình phân trang
            $scope.totalItems = 0;
            $scope.currentPage = 1;
            $scope.maxSize = 5;
            ...
            function getAll() {  
                ...
                localService.getThongTin_ThietBis({
                    Filter: vm.Filter,                    
            ...
            vm.openCreationModal = function () {
                var modalInstance = $uibModal.open({
                    ...
                    controller: 'app.views.ThongTin_ThietBi.createOrEditModal as vm',
                    backdrop: 'static',
                    resolve: {
                        id: function () {
                            return 0;
