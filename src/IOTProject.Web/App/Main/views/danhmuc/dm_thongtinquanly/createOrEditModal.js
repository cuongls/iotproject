...
(function () {
    angular.module('app').controller('app.views.DM_THONGTINQUANLY.createOrEditModal', [
        '$scope', '$uibModalInstance', 'abp.services.app.dM_THONGTINQUANLY', 'id',
        function ($scope, $uibModalInstance, localService, id) {
            ...
            vm.save = function () {    
                if (id == 0) {
                    localService.createDM_THONGTINQUANLY(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
                } else {
                    localService.updateDM_THONGTINQUANLY(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
