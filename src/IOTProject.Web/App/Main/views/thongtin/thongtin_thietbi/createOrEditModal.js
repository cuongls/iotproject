...
(function () {
    angular.module('app').controller('app.views.ThongTin_ThietBi.createOrEditModal', [
        '$scope', '$uibModalInstance', 'abp.services.app.thongTin_ThietBi', 'id',
        function ($scope, $uibModalInstance, localService, id) {
            ...
            vm.save = function () {    
                if (id == 0) {
                    localService.createThongTin_ThietBi(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
                } else {
                    localService.updateThongTin_ThietBi(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
