...
using IOTProject.Sessions;
using IOTProject.Web.Controllers.Results;
using IOTProject.Web.Models;
using IOTProject.Web.Models.Account;
...
{
    public class AccountController : IOTProjectControllerBase
    {
