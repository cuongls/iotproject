...
(function () {
    angular.module('app').controller('app.views.DM_DonVi.createOrEditModal', [
        '$scope', '$uibModalInstance', 'abp.services.app.dM_DonVi', 'id',
        function ($scope, $uibModalInstance, localService, id) {
            ...
            vm.save = function () {    
                if (id == 0) {
                    localService.createDM_DonVi(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
                } else {
                    localService.updateDM_DonVi(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
