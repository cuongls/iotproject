...
(function () {
    angular.module('app').controller('app.views.DM_TRANGTHAI.createOrEditModal', [
        '$scope', '$uibModalInstance', 'abp.services.app.dM_TRANGTHAI', 'id',
        function ($scope, $uibModalInstance, localService, id) {
            ...
            vm.save = function () {    
                if (id == 0) {
                    localService.createDM_TRANGTHAI(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
                } else {
                    localService.updateDM_TRANGTHAI(vm.objEntity)
                        .then(function () {
                            abp.notify.info(App.localize('SavedSuccessfully'));
                            $uibModalInstance.close();
                        });
